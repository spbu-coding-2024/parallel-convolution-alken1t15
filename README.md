...
- параллельная реализация сравнивается с последовательной на разных размерах изображений, фильтрах и количествах потоков;
- последовательные тесты проверяют `identity`, нулевое ядро, размер результата, диапазон каналов и работу median filter;
- явно проверяется wrap-around обработка границ;
- два противоположных фильтра-сдвига в композиции возвращают исходное изображение.
